"""
Diagnostic B: Model + profile interaction test.

Same stronger model as Diagnostic A (BAAI/bge-large-en-v1.5), but paired
with the v2 (7-block) profile that adds the "General Technical Foundations"
block, instead of the v1 6-block profile.
"""
import numpy as np
import pandas as pd
...
def main():
    print("*" * 70)
    print("  Diagnostic B: Model + profile interaction (BGE-large-en-v1.5, v2 profile)")
    print("*" * 70)
