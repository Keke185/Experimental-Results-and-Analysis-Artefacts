...
def main():
    print("*" * 50)
    print("  Cloud Layer Simulation v2 - Artifact Generator")
    ...
    print("OK, The local model was loaded successfully.")
    ...
    print(f"\n Analyze JD and role skills:{role_id}")
    ...
    print(f"OK, Vector generation complete, dimensions: {capability_vectors.shape}")
